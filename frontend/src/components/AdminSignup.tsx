...
export default function AdminSignupInt(){
    ...
    async function  createUser(){
      try{
        ...
        const userCreated = await axios.post(`${BACKEND_URL}/api/v1/admin/signup` , authorDetails);
    ...
    return <div className="flex justify-center ">
      <div className=" h-screen ">
        ...
        <div className="py-2 font-bold">Admin Authorization</div>
        <input type="password" className=" border border-gray-500 border-2 w-full p-1 rounded bg-stone-200" onChange={(e) =>{
          setAuthorDetails({
            ...authorDetails , 
            //@ts-ignore
